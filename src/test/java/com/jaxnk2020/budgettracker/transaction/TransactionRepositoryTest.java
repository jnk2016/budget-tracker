...
import com.jaxnk2020.budgettracker.monthlybudget.MonthlyBudgetRepository;
...
class TransactionRepositoryTest {
    ...
    void initializeTransactions() {
        ...
        transactions1.add(new Transaction(80, "expense", false, LocalDateTime.now().minusDays(8), monthlyBudget1, user1));
        transactions1.add(new Transaction(500, "expense", false, LocalDateTime.now().plusDays(5), monthlyBudget1, user1));
        ...
        transactions2.add(new Transaction(100, "expense", false, LocalDateTime.now().minusDays(5), monthlyBudget2, user1));
        transactions2.add(new Transaction(600, "expense", false, LocalDateTime.now().plusDays(5), monthlyBudget2, user1));
        transactions2.add(new Transaction(100, "expense", false, LocalDateTime.now().plusDays(6), monthlyBudget2, user1));
        transactions2.add(new Transaction(70, "expense", false, LocalDateTime.now().plusDays(6), monthlyBudget2, user1));
        transactions2.add(new Transaction(25, "expense", false, LocalDateTime.now().plusDays(10), monthlyBudget2, user1));
        transactions2.add(new Transaction(50, "expense", false, LocalDateTime.now().plusDays(20), monthlyBudget2, user1));
    ...
    void shouldFindByBudgetAndType() {
        List<Transaction> results = transactionRepository.findByBudgetAndType(monthlyBudget1, "expense");
